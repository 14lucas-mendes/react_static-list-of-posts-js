...
aut aut aut maxime quia temporibus ut omnis`}],Lc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],tm=({user:e})=>T.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({comment:e,users:t})=>T.jsxs("div",{className:"CommentInfo",children:[T.jsxs("div",{className:"CommentInfo__title",children:[T.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",T.jsx(tm,{user:t})]}),T.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Mc=({comments:e})=>T.jsx(T.Fragment,{children:e.map(t=>T.jsx(Tc,{comment:t},t.postId))}),Rc=({post:e,users:t})=>T.jsxs("div",{className:"PostInfo",children:[T.jsxs("div",{className:"PostInfo__header",children:[T.jsx("h3",{className:"PostInfo__title",children:e.title}),T.jsxs("p",{children:[" Posted by  ",T.jsx(tm,{user:t})]})]}),T.jsx("p",{className:"PostInfo__body",children:e.body}),T.jsx("hr",{}),T.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Dc=({posts:e})=>T.jsx(T.Fragment,{children:e.map(t=>T.jsx(Rc,{post:t},t.id))});function im(e){return Lc.find(t=>t.id===e)||null}const jc=Nc.map(e=>({...e,user:im(e.userId)})),Oc=Pc.map(e=>({...e,user:im(e.userId)})),Fc=()=>T.jsxs("section",{className:"App",children:[T.jsx("h1",{className:"App__title",children:"Static list of posts"}),T.jsxs("div",{className:"PostList",children:[T.jsx("div",{className:"PostInfo",children:T.jsx(Dc,{post:jc})}),T.jsx("div",{className:"CommentList",children:T.jsx(Mc,{comment:Oc})})]})]});em(document.getElementById("root")).render(T.jsx(Fc,{}));
